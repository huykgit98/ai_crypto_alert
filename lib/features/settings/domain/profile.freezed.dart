...
class _$ProfileImpl implements _Profile {
  _$ProfileImpl(
      ...
      required final List<UserRole>? userRoles,
      this.phoneNumber})
  ...
  @override
  String toString() {
    return 'Profile(id: $id, userName: $userName, email: $email, displayName: $displayName, userRoles: $userRoles, phoneNumber: $phoneNumber)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, userName, email, displayName,
      const DeepCollectionEquality().hash(_userRoles), phoneNumber);
...
abstract class _Profile implements Profile {
  factory _Profile(
      ...
      required final List<UserRole>? userRoles,
      final String? phoneNumber}) = _$ProfileImpl;
...
class _$UserRoleImpl implements _UserRole {
  _$UserRoleImpl({required this.id, required this.name});
...
abstract class _UserRole implements UserRole {
  factory _UserRole({required final String id, required final String name}) =
      _$UserRoleImpl;
