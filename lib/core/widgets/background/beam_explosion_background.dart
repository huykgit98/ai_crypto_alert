...
class BeamsWithCollisionBackground extends StatefulWidget {
  const BeamsWithCollisionBackground({
    super.key,
    this.child,
  });
  final Widget? child;
  ...
  @override
  State<BeamsWithCollisionBackground> createState() =>
      _BeamsWithCollisionBackgroundState();
}

class _BeamsWithCollisionBackgroundState
    extends State<BeamsWithCollisionBackground> {
